...
path_result=../Data/${subj}/ANTs_affine/Sensor_positions/
...
${ANTSPATH}/antsApplyTransformsToPoints -d 3 -i ${sensor_position_file} -o ${prefix_trasf}.csv -t [${prefix_trasf}0GenericAffine.mat,1]